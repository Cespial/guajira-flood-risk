...
\caption{Hydroclimatic response to ENSO phases (2015--2025). (\textbf{a})~Annual precipitation by ENSO phase: La Ni\~na years are wettest (mean \SI{904}{mm}), Neutral years are driest (mean \SI{702}{mm}), and El Ni\~no years show high variance due to bimodal behaviour (strong 2015 drought vs. moderate 2024 conditions). (\textbf{b})~Flood extent by ENSO phase (preliminary SAR-derived estimates).}
\label{fig:enso}
\end{figure}

Unlike Antioquia's bimodal seasonality, La Guajira's flood dynamics show a pronounced unimodal pattern with virtually zero flood extent during December--March (dry season, mean $<\SI{10}{\milli\metre/\text{month}}$) and a sharp September--November peak (October mean: \SI{198}{\milli\metre}; Figure~\ref{fig:precipitation}). CHIRPS analysis over 2015--2025 confirms the extreme ENSO sensitivity (Figure~\ref{fig:enso}): El Ni\~no years averaged \SI{793}{mm/yr} while La Ni\~na years averaged \SI{904}{mm/yr} (a 14\% increase); the 2022 triple-dip La Ni\~na year recorded \SI{1196}{mm} and 2015 strong El Ni\~no only \SI{406}{mm} \citep{GallegoRevilla2022}. No statistically significant long-term precipitation trends were detected (Mann--Kendall $p > 0.08$ for all seasons), consistent with ENSO-dominated interannual variability. However, MODIS-derived land surface temperature shows a statistically significant declining trend of $-0.34$~\SI{}{\celsius/yr} (Mann--Kendall $\tau = -0.67$, $p = 0.005$), likely reflecting increased cloudiness during the La Ni\~na-dominated latter half of the study period.

\begin{table}[htbp]
\caption{Annual precipitation and seasonal decomposition by ENSO phase (2015--2025), derived from CHIRPS Daily v2.0. All values in mm.}
\label{tab:enso}
\centering
\footnotesize
\begin{tabular}{lccccccc}
\toprule
\textbf{ENSO phase} & \textbf{$n$} & \textbf{Mean annual} & \textbf{SD} & \textbf{Dry} & \textbf{Trans.} & \textbf{Veranillo} & \textbf{Wet} \\
\midrule
El Ni\~no  & 4 & 793 & 279 & 34 & 195 & 94 & 457 \\
Neutral    & 4 & 702 & 101 & 57 & 204 & 91 & 360 \\
La Ni\~na  & 3 & 904 & 285 & 39 & 221 & 136 & 506 \\
\midrule
\textbf{All years} & 11 & 790 & 210 & 44 & 206 & 104 & 435 \\
\bottomrule
\multicolumn{8}{l}{\scriptsize Seasons: Dry (Dec--Mar), Transition (Apr--Jun), Veranillo (Jul--Aug), Wet (Sep--Nov).}\\
\multicolumn{8}{l}{\scriptsize El Ni\~no: 2015 (\SI{406}{mm}), 2016, 2023, 2024 (\SI{1067}{mm}). La Ni\~na: 2020, 2021, 2022 (\SI{1196}{mm}).}
\end{tabular}
\end{table}
