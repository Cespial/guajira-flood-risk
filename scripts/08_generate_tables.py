...
=====================
Generate publication-quality tables as CSV and LaTeX for the La Guajira
...
def generate_table5_municipal_risk() -> pd.DataFrame:
    ...
    _save_latex_styled(
        ...
        caption="Top 20 municipalities in La Guajira ranked by composite flood risk score. "
...
def generate_table6_population_exposure() -> pd.DataFrame:
    ...
    total_row = {"Subregion": "TOTAL (La Guajira)"}
    ...
    _save_latex_styled(
        ...
        caption="Population exposure to flood risk by subregion in La Guajira. "
...
def generate_table7_seasonal_dynamics() -> pd.DataFrame:
    ...
    _save_latex_styled(
        ...
        caption="Monthly flood extent statistics for La Guajira (2015--2025). "
