...
========================================
Nature-quality figures for La Guajira flood risk manuscript.
...
def load_boundary():
    return gpd.read_file(BOUNDARIES_DIR / "guajira_department_boundary_GADM41.geojson")
...
def fig01_study_area():
    ...
    guajira_p = guajira.to_crs(CRS_COLOMBIA)
    ...
    if has_colombia:
        ...
        guajira_p.plot(ax=ax, color='#d4a574', edgecolor='#333333', linewidth=0.5)
    else:
        guajira_p.plot(ax=ax, color='#d4a574', edgecolor='#333333', linewidth=0.5)
    ...
    guajira_p.boundary.plot(ax=ax, color='#333333', linewidth=0.6)
...
def fig02_sar_water_detection():
    ...
    for ax, img, label, title in panels:
        ...
        guajira.boundary.plot(ax=ax, color='#444444', linewidth=0.3)
