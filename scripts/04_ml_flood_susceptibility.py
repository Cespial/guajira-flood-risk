...
==============================
Machine Learning flood susceptibility modelling for La Guajira, Colombia.
...
def municipal_risk_stats(
    ...
    region : ee.Geometry, optional
        Clipping region (defaults to La Guajira).
...
def run_ml_pipeline(
    ...
    if data_path is None:
        data_path = cfg.DATA_DIR / "satellite_exports" / "guajira_flood_training_samples.csv"
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="ML flood susceptibility modelling for La Guajira",
    )
    parser.add_argument(
        "--data-path",
        type=pathlib.Path,
